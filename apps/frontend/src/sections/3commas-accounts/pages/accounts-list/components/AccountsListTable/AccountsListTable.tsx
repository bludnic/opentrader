...
const componentName = "ThreeCommasAccountsListTable";
const classes = {
...
type AccountsListTableProps = {
  ...
  onEditAccountClick: (account: ThreeCommasAccountDto) => void;
};
...
export const AccountsListTable: FC<AccountsListTableProps> = (props) => {
  ...
  const isSelected = (accountId: ThreeCommasAccountDto["id"]) =>
