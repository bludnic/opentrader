...
export type LimitOrderIdle<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Idle",
  T
>;
export type LimitOrderPlaced<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Placed",
  T
>;
export type LimitOrderFilled<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Filled",
  T
>;
export type LimitOrderCanceled<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Canceled",
  T
>;
export type LimitOrderRevoked<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Revoked",
  T
>;
export type LimitOrderDeleted<T extends OrderModel> = OrderEntityBuilder<
  "Limit",
  "Deleted",
  T
>;
...
export type MarketOrderIdle<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Idle",
  T
>;
export type MarketOrderPlaced<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Placed",
  T
>;
export type MarketOrderFilled<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Filled",
  T
>;
export type MarketOrderCanceled<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Canceled",
  T
>;
export type MarketOrderRevoked<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Revoked",
  T
>;
export type MarketOrderDeleted<T extends OrderModel> = OrderEntityBuilder<
  "Market",
  "Deleted",
  T
>;
...
export type OrderEntity<T extends OrderModel = OrderModel> =
  | LimitOrder<T>
  | MarketOrder<T>;
