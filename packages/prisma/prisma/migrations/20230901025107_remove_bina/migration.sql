/*
  ...
  - The values [BINA] on the enum `ExchangeCode` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ExchangeCode_new" AS ENUM ('OKX');
