...
import { SmartTradeProfitStepPriceType } from 'src/core/db/firestore/repositories/tweet-trading-bots/types/smart-trade-take-profit/take-profit-step/profit-step-price/enums/smart-trade-profit-step-price-type.enum';
import { ITweetTradingBotSmartTradeSettings } from 'src/core/db/firestore/repositories/tweet-trading-bots/types/tweet-trading-bot/types/smart-trade-settings/tweet-trading-bot-smart-trade-settings.interface';
