...
import { SmartTradePositionDto } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-position/smart-trade-position.dto';
import { SmartTradePositionEntity } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-position/smart-trade-position.entity';
...
import { SmartTradeStopLossDto } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-stop-loss/smart-trade-stop-loss.dto';
import { SmartTradeStopLossEntity } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-stop-loss/smart-trade-stop-loss.entity';
...
import { SmartTradeTakeProfitDto } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-take-profit/smart-trade-take-profit.dto';
import { SmartTradeTakeProfitEntity } from 'src/experiments/3commas-tweet-smart-trading/db/repositories/tweet-trading-bots/types/smart-trade-take-profit/smart-trade-take-profit.entity';
